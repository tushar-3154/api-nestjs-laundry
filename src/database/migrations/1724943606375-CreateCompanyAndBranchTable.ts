...
export class CreateCompanyAndBranchTable1724943606375
  implements MigrationInterface
{
  name = 'CreateCompanyAndBranchTable1724943606375';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`branches\` ADD CONSTRAINT \`FK_5973f79e64a27c506b07cd84b29\` FOREIGN KEY (\`company_id\`) REFERENCES \`companys\`(\`company_id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
}
